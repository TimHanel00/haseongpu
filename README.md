...
launch. It uses revivalTuner's default one-dimensional frame extents 32, 64,
128, 256, 512, and 1024. Frame-count candidates are generated by repeatedly
halving an application-specific upper limit of four times the original count
and adding the integer midpoint between adjacent splits. This explicit HASE
space intentionally has no coverage restriction because the kernels use
Alpaka's strided index mapping over their actual problem ranges. Kernels are
not replayed and no physics parameter is tuned.
...
`58c2e0e4fce1e0e7d1860c8a9504ec9f6b06e448`.
