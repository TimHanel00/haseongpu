...
Continue with :doc:`Binary Interface <binaryInterface>`. For the schema and transport backends used by both Python and the binary, see :doc:`openPMD Transport <openpmdTransport>`.
