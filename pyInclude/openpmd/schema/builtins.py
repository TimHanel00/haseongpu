...
SIMULATION_ATTRIBUTE_SPECS = (
    ...
    ExtensionAttributeSpec("propagationMode", "propagation_mode", "str"),
    ExtensionAttributeSpec("forwardRayCount", "forward_ray_count", "int", unit="count"),
    ExtensionAttributeSpec("forwardRayLength", "forward_ray_length", "float", unit="m", unitDimension=LENGTH),
