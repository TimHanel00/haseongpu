...
passive cells. All gain components must reference the same resolved ``Material``
object. Unsupported heterogeneous material response is rejected instead of
being selected or averaged silently.
