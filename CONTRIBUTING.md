...
5. Build the native helper targets before running Python tests from a raw
   checkout, or install the Python package so `pyInclude/_native` contains
   the generated executables and libraries.
