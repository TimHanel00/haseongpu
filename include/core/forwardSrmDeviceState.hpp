...
namespace hase::core
{
    ...
    public:
        ...
        {
            return prepareSamplingCdf(m_reservoirA, 0u);
        }
        ...
        {
            return prepareSamplingCdf(currentInputReservoir(), pass);
        }
    ...
    private:
        ...
        [[nodiscard]] double prepareSamplingCdf(T_Reservoir const& reservoir, unsigned const pass)
        {
